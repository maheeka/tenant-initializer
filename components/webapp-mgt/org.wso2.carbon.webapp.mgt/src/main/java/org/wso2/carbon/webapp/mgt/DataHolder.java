...
public class DataHolder {
    ...
    protected static TenantMgtAdminService tenantMgtAdminService;
    protected static TenantManager tenantManager;
    ...
    public static void setDeploymentSynchronizerService(DeploymentSynchronizer deploymentSynchronizerService) {
    ...
    public static void setTenantMgtAdminService(TenantMgtAdminService tenantMgtAdminService) {
        DataHolder.tenantMgtAdminService = tenantMgtAdminService;
    }

    public static TenantManager getTenantManager() {
        return DataHolder.tenantManager;
    }

    public static void setTenantManager(TenantManager tenantManager) {
        DataHolder.tenantManager = tenantManager;
    }

    public static TenantMgtAdminService getTenantMgtAdminService() {
        return DataHolder.tenantMgtAdminService;
    }

    public static void setTenantRegistryLoader(TenantRegistryLoader tenantRegistryLoader) {
        DataHolder.tenantRegistryLoader = tenantRegistryLoader;
    }
